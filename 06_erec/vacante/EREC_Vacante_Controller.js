...
function _erecDoGetPublico(e) {
  ...
  var tpl = HtmlService.createTemplateFromFile('06_erec/vacante/EREC_FormPostulante');
...
function abrirFormVacante() {
  ...
  var html = HtmlService.createTemplateFromFile('06_erec/vacante/EREC_FormVacante')
    .evaluate()
    .setWidth(760)
    .setHeight(700);
...
function diagnosticarTemplate() {
  try {
    var tpl = HtmlService.createTemplateFromFile('06_erec/vacante/EREC_FormVacante');
